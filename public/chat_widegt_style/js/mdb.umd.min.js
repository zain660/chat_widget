...
(function ($) {
    $.fn.chatBoxInit = function (app_key) {
        ...
        $.ajax({
            'type': 'get',
            'url': 'http://127.0.0.1:8000/append_chat/'+app_key.app_key+'',
        ...
        //                     <div class="card">
        //                         <div class="card-header d-flex justify-content-between align-items-center p-3" style="border-top: 4px solid ${settings.chatBoxPrimaryColor};">
        //                             <h5 class="mb-0">Support Live Chat</h5>
        //                             <div class="d-flex flex-row align-items-center">
        //                                 <i class="fas fa-times text-muted fa-xs" id="closeChat"></i>
        //                             </div>
        //                         </div>
        //                         <div class="card-body" data-mdb-perfect-scrollbar-init style="position: relative; height: calc(${settings.chatBoxHeight} - 100px); overflow: auto;">
        //                             <!-- Chat messages here -->
        ...
        //                                 <div>
        //                                     <p class="small p-2 ms-3 mb-3 rounded-3 bg-body-tertiary">For what reason would it be advisable for me to think about business content?</p>
        //                                 </div>
        //                             </div>
        //                             <div class="d-flex justify-content-between">
        ...
        //                                 <div>
        //                                     <p class="small p-2 me-3 mb-3 text-white rounded-3" style="background-color:${settings.chatBoxPrimaryColor}">Thank you for your belief in our support</p>
        //                                 </div>
        ...
        //                                 <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava5-bg.webp" alt="avatar 1" style="width: 45px; height: 100%;">
        //                                 <div>
        //                                     <p class="small p-2 ms-3 mb-3 rounded-3 bg-body-tertiary">Lorem ipsum dolor sit amet consectetur adipisicing elit similique quae consequatur</p>
        //                                 </div>
        //                             </div>
        //                         </div>
        ...
        //                                 <button data-mdb-button-init data-mdb-ripple-init class="btn text-white" type="button" id="button-addon2" style="background-color: ${settings.chatBoxPrimaryColor}; padding-top: .55rem;">
        ...
        // $chatContainer.html(chatBoxContent);

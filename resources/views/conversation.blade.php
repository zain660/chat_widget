...
@section('content')
    ...
    <style>
        @media only screen and (max-width: 768px) {
            ...
            /* Hide the section on devices with maximum width of 768px */
            .sidebar-header {
                display: none;
            }
        }
        ...
        <div class="chat-body">
            ...
            <div class="chat-header">
                ...
                <button class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted"
                    onclick="location.href = '{{ route('home') }}'" type="button">
                    <!-- Default :: Inline SVG -->
            ...
            <div class="container shadow p-3 mb-5 bg-white rounded" id="image_display">
                ...
                <img class="injectable hw-20 img-thumbnail" id="preview_sending_img" src="#">
                ...
                <div class="hide-scrollbar flex-fill">
                    ...
                    <div class="text-center p-3">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a class="btn btn-danger btn-icon rounded-circle text-light mx-1"
                                href="/block/{{ $id }}">
                                <!-- Default :: Inline SVG -->
                                <svg class="hw-20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

        ...
        <div class="chat-body">
            ...
            <div class="chat-header">
                ...
                <div class="media chat-name align-items-center text-truncate">
                    <div class="avatar bg-success text-light d-none d-sm-inline-block mr-3">
                        <span>
                            <img class="injectable"src="{{ asset('/group_thumb') }}/{{ $group_details->group_thumb }}"
                                alt="">
                        </span>
                    </div>
                    ...
                    <li class="nav-item list-inline-item d-none d-sm-block mr-0">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" style="">
                                <a class="dropdown-item align-items-center d-flex" href="/leave_group/{{ $id }}"
            ...
            <form method="post" enctype="multipart/form-data" id="send_container_messge">
                                ...
                                <div class="input-group-prepend mr-sm-2 mr-1">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <div class="file_choosen_trigger" onclick="document.getElementById('image_file_choosen').click()">
                                                <a class="dropdown-item" href="#">
                                                    ...
                                                    <span><input type="file" class="hide_file" name="image_file_choosen"
                                                            onchange="read_file_choosenURL(this);" id="image_file_choosen"
                                                            style="display: none;">
                                                        Gallery</span>
                                                </a>
                                            </div>
                ...
                <div class="container shadow p-3 mb-5 bg-white rounded" id="image_display">
                    ...
                    <img class="injectable hw-20 img-thumbnail" id="group_file_preview" src="#">
                        ...
                        <div class="avatar bg-success text-light avatar-xl mx-5 mb-3">
                            <span>
                                <img class="injectable hw-50"
                                    src="{{ asset('/group_thumb') }}/{{ $group_details->group_thumb ?? 'avatar.png' }}"
                                    alt="">
                            </span>
                        </div>
                            ...
                            <div class="chat-info-group-content list-item-has-padding">
                                ...
                                <ul class="list-group list-group-flush">
                                    @foreach ($member as $members)
                                        @php
                                            $member_details = App\Models\User::where(
                                                'id',
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <div class="avatar mr-2">
                                                    <img src="{{ asset('/assets/media/avatar') }}/{{ $member_details->avatar ?? 'avatar.png' }}"
                                                        alt="">
                                                </div>
...
@push('custom_js')
    ...
    <script type="text/javascript">
        ...
        function read_file_choosenURL(input) {
    ...
    <script>
        var reff = firebase.database().ref("group_id_{{ $id }}/group_messages");
        reff.on('child_added', function(snapshot) {

            var AuthName = '{{ auth()->user()->id }}'
            var myname = "{{ Auth::user()->id }}";
            var name = (myname == snapshot.val().sender_id) ? myname : snapshot.val().sender_id;
